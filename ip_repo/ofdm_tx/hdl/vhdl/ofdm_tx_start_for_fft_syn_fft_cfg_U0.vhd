...
entity ofdm_tx_start_for_fft_syn_fft_cfg_U0 is 
    generic (
...
architecture rtl of ofdm_tx_start_for_fft_syn_fft_cfg_U0 is
...
------------------------Component----------------------
    component ofdm_tx_start_for_fft_syn_fft_cfg_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 5);
...
begin
----------------------- Instantiation -----------------------
    U_ofdm_tx_start_for_fft_syn_fft_cfg_U0_ShiftReg : ofdm_tx_start_for_fft_syn_fft_cfg_U0_ShiftReg
    generic map (
...
entity ofdm_tx_start_for_fft_syn_fft_cfg_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 5);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end ofdm_tx_start_for_fft_syn_fft_cfg_U0_ShiftReg;

architecture rtl of ofdm_tx_start_for_fft_syn_fft_cfg_U0_ShiftReg is
