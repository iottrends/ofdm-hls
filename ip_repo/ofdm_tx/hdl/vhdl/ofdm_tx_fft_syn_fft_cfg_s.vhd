...
entity ofdm_tx_fft_syn_fft_cfg_s is
    generic (
...
architecture arch of ofdm_tx_fft_syn_fft_cfg_s is
attribute DowngradeIPIdentifiedWarnings : STRING;
attribute DowngradeIPIdentifiedWarnings of arch : architecture is "yes";
    --------------------- Component ---------------------
    component ofdm_tx_fft_syn_fft_cfg_s_core_ip is
        port (
            aclk                        : in  std_logic;
            aclken                      : in  std_logic;
...
begin
    --------------------- Instantiation -----------------
    inst : component ofdm_tx_fft_syn_fft_cfg_s_core_ip
    port map (
        aclk                        => ap_clk,
        aclken                      => ap_ce,
        aresetn                     => aresetn,
