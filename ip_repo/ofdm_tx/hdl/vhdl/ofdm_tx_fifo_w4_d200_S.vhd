...
entity ofdm_tx_fifo_w4_d200_S is 
    generic (
...
architecture rtl of ofdm_tx_fifo_w4_d200_S is
...
------------------------Component----------------------
    component ofdm_tx_fifo_w4_d200_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 4;
        ADDR_WIDTH : integer := 8;
        DEPTH      : integer := 200);
...
begin
----------------------- Instantiation -----------------------
    U_ofdm_tx_fifo_w4_d200_S_ShiftReg : ofdm_tx_fifo_w4_d200_S_ShiftReg
    generic map (
...
entity ofdm_tx_fifo_w4_d200_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 4;
        ADDR_WIDTH : integer := 8;
        DEPTH      : integer := 200);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end ofdm_tx_fifo_w4_d200_S_ShiftReg;

architecture rtl of ofdm_tx_fifo_w4_d200_S_ShiftReg is
