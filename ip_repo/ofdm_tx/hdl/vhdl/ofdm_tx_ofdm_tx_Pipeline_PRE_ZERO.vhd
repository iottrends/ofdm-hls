...
entity ofdm_tx_ofdm_tx_Pipeline_PRE_ZERO is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ofdm_tx_ofdm_tx_Pipeline_PRE_ZERO is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln419_fu_82_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal zext_ln419_fu_94_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_5_fu_42 : STD_LOGIC_VECTOR (8 downto 0) := "000000000";
    signal add_ln419_fu_88_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if ((icmp_ln419_fu_82_p2 = ap_const_lv1_0)) then 
                    i_5_fu_42 <= add_ln419_fu_88_p2;
    ...
    add_ln419_fu_88_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv9_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln419_fu_82_p2)
    begin
        if (((icmp_ln419_fu_82_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    freq_M_imag_address0 <= zext_ln419_fu_94_p1(8 - 1 downto 0);
    ...
    freq_M_imag_we0_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln419_fu_82_p2)
    begin
        if (((icmp_ln419_fu_82_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    freq_M_real_address0 <= zext_ln419_fu_94_p1(8 - 1 downto 0);
    ...
    freq_M_real_we0_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln419_fu_82_p2)
    begin
        if (((icmp_ln419_fu_82_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    icmp_ln419_fu_82_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv9_100) else "0";
    zext_ln419_fu_94_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i),64));
end behav;
