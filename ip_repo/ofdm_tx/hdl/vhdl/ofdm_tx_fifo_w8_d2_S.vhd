...
entity ofdm_tx_fifo_w8_d2_S is 
    generic (
...
architecture rtl of ofdm_tx_fifo_w8_d2_S is
...
------------------------Component----------------------
    component ofdm_tx_fifo_w8_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_ofdm_tx_fifo_w8_d2_S_ShiftReg : ofdm_tx_fifo_w8_d2_S_ShiftReg
    generic map (
...
entity ofdm_tx_fifo_w8_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end ofdm_tx_fifo_w8_d2_S_ShiftReg;

architecture rtl of ofdm_tx_fifo_w8_d2_S_ShiftReg is
