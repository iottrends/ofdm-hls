...
module ofdm_tx_ofdm_tx_Pipeline_PRE_ZERO (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln419_fu_82_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln419_fu_94_p1;
reg   [8:0] i_5_fu_42;
wire   [8:0] add_ln419_fu_88_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln419_fu_82_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln419_fu_82_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln419_fu_82_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln419_fu_88_p2 = (ap_sig_allocacmp_i + 9'd1);
...
assign freq_M_imag_address0 = zext_ln419_fu_94_p1;
...
assign freq_M_real_address0 = zext_ln419_fu_94_p1;
...
assign icmp_ln419_fu_82_p2 = ((ap_sig_allocacmp_i == 9'd256) ? 1'b1 : 1'b0);

assign zext_ln419_fu_94_p1 = ap_sig_allocacmp_i;
