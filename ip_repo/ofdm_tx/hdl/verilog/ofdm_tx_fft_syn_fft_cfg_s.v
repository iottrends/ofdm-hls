...
(* DowngradeIPIdentifiedWarnings="yes" *) module ofdm_tx_fft_syn_fft_cfg_s
#(parameter
    INPUT_WIDTH  = 32,
    OUTPUT_WIDTH = 32,
    CONFIG_WIDTH = 16,
...
wire status_tvalid;
//------------------------Instantiation------------------
ofdm_tx_fft_syn_fft_cfg_s_core_ip inst (
  .aclk                        ( ap_clk ),
  .aclken                      ( ap_ce ),
  .aresetn                     ( aresetn ),
...
assign xk_full_n_i    = xk_full_n & ap_start & (!ap_done | ap_continue);
