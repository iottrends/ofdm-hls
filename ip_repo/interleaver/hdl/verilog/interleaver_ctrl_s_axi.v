...
// ==============================================================
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module interleaver_ctrl_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER           = 6'h08,
    ADDR_ISR           = 6'h0c,
    ADDR_MOD_R_DATA_0  = 6'h10,
    ADDR_MOD_R_CTRL    = 6'h14,
    ADDR_N_SYMS_DATA_0 = 6'h18,
    ADDR_N_SYMS_CTRL   = 6'h1c,
    ADDR_IS_RX_DATA_0  = 6'h20,
    ADDR_IS_RX_CTRL    = 6'h24,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IS_RX_DATA_0)
            int_is_rx[0:0] <= (WDATA[31:0] & wmask) | (int_is_rx[0:0] & ~wmask);
    end
end
