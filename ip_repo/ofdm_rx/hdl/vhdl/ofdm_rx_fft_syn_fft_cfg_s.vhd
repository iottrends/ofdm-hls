...
entity ofdm_rx_fft_syn_fft_cfg_s is
    generic (
...
architecture arch of ofdm_rx_fft_syn_fft_cfg_s is
attribute DowngradeIPIdentifiedWarnings : STRING;
attribute DowngradeIPIdentifiedWarnings of arch : architecture is "yes";
    --------------------- Component ---------------------
    component ofdm_rx_fft_syn_fft_cfg_s_core_ip is
        port (
            aclk                        : in  std_logic;
            aclken                      : in  std_logic;
...
begin
    --------------------- Instantiation -----------------
    inst : component ofdm_rx_fft_syn_fft_cfg_s_core_ip
    port map (
        aclk                        => ap_clk,
        aclken                      => ap_ce,
        aresetn                     => aresetn,
    ...
    xk_full_n_i     <= xk_full_n and ap_start and (not ap_done_i or ap_continue);
