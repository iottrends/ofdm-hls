...
entity ofdm_rx_ofdm_rx_Pipeline_DRAIN is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ofdm_rx_ofdm_rx_Pipeline_DRAIN is 
...
begin
    ...
    ap_block_state1_pp0_stage0_iter0_assign_proc : process(iq_in_TVALID, ap_start_int)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_start_int = ap_const_logic_0) or (iq_in_TVALID = ap_const_logic_0));
    end process;
    ...
    iq_in_TREADY_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0)
    begin
        if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
