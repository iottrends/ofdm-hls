...
entity ofdm_rx_fifo_w32_d8_S is 
    generic (
...
architecture rtl of ofdm_rx_fifo_w32_d8_S is
...
------------------------Component----------------------
    component ofdm_rx_fifo_w32_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
...
begin
----------------------- Instantiation -----------------------
    U_ofdm_rx_fifo_w32_d8_S_ShiftReg : ofdm_rx_fifo_w32_d8_S_ShiftReg
    generic map (
...
entity ofdm_rx_fifo_w32_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end ofdm_rx_fifo_w32_d8_S_ShiftReg;

architecture rtl of ofdm_rx_fifo_w32_d8_S_ShiftReg is
