...
entity sync_detect_ctrl_s_axi is
generic (
...
end entity sync_detect_ctrl_s_axi;
...
architecture behave of sync_detect_ctrl_s_axi is
...
attribute DowngradeIPIdentifiedWarnings of behave : architecture is "yes";
    ...
    constant ADDR_N_SYMS_DATA_0 : INTEGER := 16#10#;
    constant ADDR_N_SYMS_CTRL   : INTEGER := 16#14#;
