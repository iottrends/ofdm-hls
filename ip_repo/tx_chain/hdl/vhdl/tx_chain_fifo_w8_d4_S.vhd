...
entity tx_chain_fifo_w8_d4_S is 
    generic (
...
architecture rtl of tx_chain_fifo_w8_d4_S is
...
------------------------Component----------------------
    component tx_chain_fifo_w8_d4_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
...
begin
----------------------- Instantiation -----------------------
    U_tx_chain_fifo_w8_d4_S_ShiftReg : tx_chain_fifo_w8_d4_S_ShiftReg
    generic map (
...
entity tx_chain_fifo_w8_d4_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end tx_chain_fifo_w8_d4_S_ShiftReg;

architecture rtl of tx_chain_fifo_w8_d4_S_ShiftReg is
