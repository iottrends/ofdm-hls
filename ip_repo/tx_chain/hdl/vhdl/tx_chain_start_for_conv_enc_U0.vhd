...
entity tx_chain_start_for_conv_enc_U0 is 
    generic (
...
architecture rtl of tx_chain_start_for_conv_enc_U0 is
...
------------------------Component----------------------
    component tx_chain_start_for_conv_enc_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_tx_chain_start_for_conv_enc_U0_ShiftReg : tx_chain_start_for_conv_enc_U0_ShiftReg
    generic map (
...
entity tx_chain_start_for_conv_enc_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end tx_chain_start_for_conv_enc_U0_ShiftReg;

architecture rtl of tx_chain_start_for_conv_enc_U0_ShiftReg is
