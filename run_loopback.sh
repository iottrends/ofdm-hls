...
echo ""
./setup_vitis.sh csim 2>&1 | tee /tmp/loopback_tx_csim.log | grep -E "@I|@E|error" || true
echo ""
...
log "Running: ./setup_vitis.sh rx_csim"
...
echo ""
./setup_vitis.sh rx_csim 2>&1 | tee /tmp/loopback_rx_csim.log | grep -E "\[TB\]" || true
echo ""
